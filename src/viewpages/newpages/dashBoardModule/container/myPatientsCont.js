...
function MyPatientCont(props) {
   ...
   const fetchPatientList = (callBack = () => {}, refetch = false) => {
      var obj = refetch
         ? { offset: 0, limit: 10, myPatients: true }
         : { offset: patientList.offset + patientList.limit, limit: patientList.limit, myPatients: true };
...
const mapStateToProps = (state) => {
   return {
      patientList: state.patientlist.myPatients,
   };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(MyPatientCont);
