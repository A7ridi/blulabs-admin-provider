...
import { GET_THUMBNAIL_SIGNED_URL, UPDATE_ITEM_VIEWED_STATUS } from "../../../profileModule/actions/profileQueries";
...
const PostViewGql = memo(
   (props) => {
      const { data, className, isPreview, PostCard, user, refetch } = props;
